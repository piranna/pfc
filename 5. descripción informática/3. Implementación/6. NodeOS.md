...
[^1]: Anteriormente hice uso de [TravisCI](https://travis-ci.org) y de [CodeShip](https://codeship.com), pero el primero tenia poca potencia de cálculo y provocaba que todas las ejecuciones fallaran por timeout y el segundo no me permitia instalar las dependencias y paquetes del sistema que necesitaba para la compilación y testeo.
