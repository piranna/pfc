...
Para los sistemas embebidos y dedicados puede ser suficiente con el uso del
...
pero para la creación de interfaces mas complejas o la creación de un entorno de
escritorio, la solución óbvia es el uso de HTML5 y tecnologias web. En este
...
[nw.js](http://nwjs.io) o el diseño de una API propia. De esta forma, no solo
permite que se pueda ejecutar dicha interfaz gráfica en cualquier navegador web
estandar, sino que ademas reduce el consumo de recursos en el servidor al
