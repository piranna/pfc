...
registrara el servidor proporcionado por el módulo hipotético `steam` (basado en
...
relativas para que puedan ser agnósticas respecto al uso del identificador del
módulo dentro de la ruta o no, lo cual aunque pueda complicarlas en algunos
