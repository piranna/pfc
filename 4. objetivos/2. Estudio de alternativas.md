...
para tener un entorno similar al ofrecido por NodeOS. Sin embargo, este enfoque
de usar un sistema operativo ya existente (aunque sea una version reducida) en
lugar de ejecutar Node.js directamente sobre el kernel de Linux presenta dos
desventajas:
